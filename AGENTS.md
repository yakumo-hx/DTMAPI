...
Before Runtime Workshop installer/package-layout changes or player installer-failure work, also read:

- `docs/architecture/runtime-workshop-installer-boundary.md`
- `docs/workflows/workshop-package-subscription-test-matrix.md`
- the latest relevant installer Review, Debug issue and Update

The architecture boundary owns current BAT/CMD/PowerShell responsibilities. Dated phase summaries, historical Updates and old package bytes are audit evidence, not current installer design authority.
