...
public class RedSawVerticalTiledPanelLayoutGroup : LayoutGroup
{
	...
	protected void calTiledPanel()
	{
		...
		if (base.transform.childCount == 3)
		{
			...
			Vector2 sizeDelta = new Vector2(sideSize.x, base.rectTransform.sizeDelta.y);
			...
			base.rectChildren[1].sizeDelta = new Vector2(sizeDelta.x, sizeDelta.y - sideSize.y * 2f);
			base.rectChildren[2].sizeDelta = sideSize;
			base.rectChildren[2].localPosition = Vector3.zero;
			base.rectChildren[1].localPosition = new Vector3(0f, sideSize.y, 0f);
			base.rectChildren[0].localPosition = new Vector3(0f, sizeDelta.y - sideSize.y, 0f);
		}
	}
}
