...
public class CraftGridPanel<TSlot, TViewer, TData> : DolocPagedGridUI<TSlot, TData>, ICraftPanel<TData>, IPageUI<TData>, IView where TSlot : CraftSlot<TData> where TViewer : CraftViewer<TData> where TData : ICraftData
{
	[SerializeField]
