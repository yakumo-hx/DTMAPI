...
public class LargeQuesitionUiState : DolocUiState<QuestionBoxLarge>
{
	...
	public bool HandleStartUpArgs(string title, string description, Action onConfirm, Action onCancel, bool firstSelectedConfirm)
	{
		base.panel.Title = title;
		base.panel.Description = description;
