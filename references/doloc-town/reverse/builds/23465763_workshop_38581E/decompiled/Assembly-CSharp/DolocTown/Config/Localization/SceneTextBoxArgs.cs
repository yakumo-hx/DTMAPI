...
public sealed class SceneTextBoxArgs : TipTextArgsBase
{
	public const int __ID__ = -1815268892;

	public AlignmentText Title { get; private set; }

	public AlignmentText Signature { get; private set; }

	public SceneTextBoxArgs(JSONNode _json)
		: base(_json)
	{
	...
	public SceneTextBoxArgs(AlignmentText content, AlignmentText title, AlignmentText signature)
		: base(content)
	{
		Title = title;
		Signature = signature;
	...
	public static SceneTextBoxArgs DeserializeSceneTextBoxArgs(JSONNode _json)
	{
		return new SceneTextBoxArgs(_json);
	}
