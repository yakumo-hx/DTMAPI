...
public sealed class EquipmentFuncLintRoller : EquipmentFuncEquipment
{
	public const int __ID__ = -2112517569;
	...
	public EquipmentFuncLintRoller(JSONNode _json)
		: base(_json)
	{
	...
	public EquipmentFuncLintRoller(int capacity, SpriteAsset half_sprite, SpriteAsset full_sprite)
	{
		Capacity = capacity;
	...
	public static EquipmentFuncLintRoller DeserializeEquipmentFuncLintRoller(JSONNode _json)
	{
		return new EquipmentFuncLintRoller(_json);
	}
