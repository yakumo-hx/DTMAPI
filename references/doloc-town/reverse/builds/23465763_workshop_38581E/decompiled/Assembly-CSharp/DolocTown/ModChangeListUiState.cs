...
public class ModChangeListUiState : DolocUiState<ModChangeListPanel>
{
	...
	public bool HandleStartUpArgs(ModChangeData data, Action onConfirm, Action onCancel, bool firstSelectedConfirm)
	{
