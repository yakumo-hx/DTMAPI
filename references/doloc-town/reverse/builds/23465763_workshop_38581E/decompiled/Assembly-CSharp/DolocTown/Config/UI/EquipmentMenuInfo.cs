...
public sealed class EquipmentMenuInfo : BeanBase
{
	public const int __ID__ = 1234039137;

	public EquipmentMenuSubType Id { get; private set; }
	...
	public EquipmentMenuInfo(JSONNode _json)
	{
		if (!_json["id"].IsNumber)
		{
			throw new SerializationException();
		}
		Id = (EquipmentMenuSubType)_json["id"].AsInt;
	...
	public EquipmentMenuInfo(EquipmentMenuSubType id, SpriteAsset icon_asset, string title)
	{
		Id = id;
	...
	public static EquipmentMenuInfo DeserializeEquipmentMenuInfo(JSONNode _json)
	{
		return new EquipmentMenuInfo(_json);
	}
