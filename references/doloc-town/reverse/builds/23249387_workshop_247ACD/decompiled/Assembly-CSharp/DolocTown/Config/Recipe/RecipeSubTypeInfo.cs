...
public sealed class RecipeSubTypeInfo : BeanBase
{
	...
	public RecipeSubTypeInfo(string id, string main_type, string title, string item_title_format, string item_desc_format)
	{
		Id = id;
		MainType = main_type;
		Title = title;
	...
	{
		return "{ Id:" + Id + ",MainType:" + MainType + ",Title:" + Title + ",ItemTitleFormat:" + ItemTitleFormat + ",ItemDescFormat:" + ItemDescFormat + ",}";
	}
}
