...
public sealed class EquipmentFuncMilkingMachine : EquipmentFuncEquipment
{
	public const int __ID__ = -1983884846;
	...
	public EquipmentFuncMilkingMachine(JSONNode _json)
		: base(_json)
	{
	...
	public EquipmentFuncMilkingMachine(int capacity, SpriteAsset half_sprite, SpriteAsset full_sprite)
	{
		Capacity = capacity;
	...
	public static EquipmentFuncMilkingMachine DeserializeEquipmentFuncMilkingMachine(JSONNode _json)
	{
		return new EquipmentFuncMilkingMachine(_json);
	}
