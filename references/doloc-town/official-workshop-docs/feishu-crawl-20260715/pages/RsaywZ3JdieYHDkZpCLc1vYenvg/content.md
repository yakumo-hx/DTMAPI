...
- 给罐头增加掉落保底：每击杀2个掉落库里包含罐头的怪物，必然掉落1个罐头。
...
[
  {
    "type": 1, //保底类型（0资源采集掉落，1怪物掉落，2钓鱼掉落）
    "spawn_id": "can", // 目标道具ID
    "global_limit": 0, // 不生效
...
- 给垃圾增加全局数量上限：从水里钓起1个垃圾后，就再也钓不到垃圾了。
...
[
  {
    "type": 2, //保底类型（0资源采集掉落，1怪物掉落，2钓鱼掉落）
    "spawn_id": "rubbish", // 目标道具ID
    "global_limit": 1, // 全局数量上限（0则无上限）
    "default_locked": false, //不生效
    "viewable": false, //不生效
    "active_count": 0,//不生效
