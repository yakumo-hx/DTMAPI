...
namespace DTMAPI.Abstractions
{
    ...
    [DtmApiStatus(DtmApiStatus.Experimental, Since = "0.2.0")]
    [DtmApiDisposition(DtmApiDisposition.Diagnostic, Since = "0.5.5", Notes = "Diagnostic surface after the explicitly authorized retirement of the unused CSV export; remaining members are compatibility-only and not a gameplay authoring API.")]
