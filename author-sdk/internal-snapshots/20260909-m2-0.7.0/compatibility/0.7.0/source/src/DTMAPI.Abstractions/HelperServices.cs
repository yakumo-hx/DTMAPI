...
{
    [DtmApiStatus(DtmApiStatus.Experimental, Since = "0.7.0", Notes = "Candidate optional platform services; only exact supported contract types resolve. Does not extend IDtmHelper's required members.")]
