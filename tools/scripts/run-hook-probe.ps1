...
$checks = [ordered]@{
    ...
    ActionSpeedUpdateTicked = Test-LogLine -LogPath $logPath -Pattern 'ActionSpeed UpdateTicked OK'
    OneActionEntry = Test-LogLine -LogPath $logPath -Pattern 'OneActionComplete migrated to DTMAPI shell'
    OneActionUpdateTicked = Test-LogLine -LogPath $logPath -Pattern 'OneActionComplete UpdateTicked OK'
    ...
    AutoFishingUpdateTicked = Test-LogLine -LogPath $logPath -Pattern 'AutoFishing UpdateTicked OK'
    ...
    FishBreedingUpdateTicked = Test-LogLine -LogPath $logPath -Pattern 'FishBreedingAssistant UpdateTicked OK'
    ...
    AnimalProgressUpdateTicked = Test-LogLine -LogPath $logPath -Pattern 'AnimalHusbandryProgress UpdateTicked OK'
