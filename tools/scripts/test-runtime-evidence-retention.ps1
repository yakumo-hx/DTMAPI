...
try {
    ...
    $expectedBatch6ManagerRoots = @('BATCH6-AUTOFISHING-MANAGER-LIFECYCLE/20260721-121144-ded2b298')
    $expectedBatch6BehaviorRoots = @('BATCH6-AUTOFISHING-BEHAVIOR-MATRIX/20260721-122112-c46597d6')
    ...
    $expectedCandidateRoots = @('CANDIDATE11/batch5-final-manual-handshake-20260719-214044')
