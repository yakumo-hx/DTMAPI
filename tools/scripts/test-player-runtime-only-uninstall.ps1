...
try {
    ...
    Assert-OwnershipTest -Condition ($installText -match 'Author SDK package/deployment authority is unavailable') -Message 'Managed Advanced deployment no longer fails closed when its Author SDK authority is unavailable.'
