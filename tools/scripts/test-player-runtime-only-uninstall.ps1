...
try {
    ...
    Assert-OwnershipTest -Condition ($installText.Contains('Managed product installation through this Runtime installer is unavailable.')) -Message 'Managed Advanced deployment no longer fails closed at the Runtime-only installer boundary.'
