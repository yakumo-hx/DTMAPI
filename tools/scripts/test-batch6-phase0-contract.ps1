...
Assert-ExactValue 'Runtime release/API version authority' $runtimeVersionProperties.DtmApiReleaseVersion '0.5.5'
Assert-ExactValue 'Runtime binary/file version authority' $runtimeVersionProperties.DtmApiBinaryFileVersion '0.5.5.0'
...
foreach ($token in @('release/API `0.5.5`', 'binary/file `0.5.5.0`', 'assembly compatibility `0.5.3.0`', 'future `0.5.6-alpha` requirement is blocked')) {
