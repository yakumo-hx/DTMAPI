    ...
    internal sealed class MoreSavesNativeRuntime
    {
        ...
        internal void Configure(MoreSavesConfig value, string reason)
        {
            ...
            try
            {
                ...
                if (config.Enabled)
                {
                    ...
                    TryApply(ExpandedSlotCount, reason ?? "configure");
                    return;
                }
        ...
        internal void Update()
        {
            ...
            try
            {
                ...
                {
                    EnsureLease();
                    TryApply(ExpandedSlotCount, "bounded native-manager retry");
                }
                else
        ...
        internal void ResetBoundary(string reason)
        {
            ...
            try
            {
                ...
                TryApply(ExpandedSlotCount, reason ?? "lifecycle boundary");
            }
            finally
            {
                ReconcileRetryDemand();
