...
namespace Yuuka.DTMAPI.ActionSpeed
{
    public sealed class ModEntry : DtmMod, IDisposable
    {
        ...
        private void RegisterConfigMenu()
        {
            ...
            menu.AddInlineBoolNumberOption(helper.ModManifest, () => T("config.toolSpeed.name", "Tool animation speed"), () => T("config.toolSpeed.tooltip", "Axe, pickaxe, sickle, and manual watering-can animation speed."), () => config.ToolSpeedEnabled, value => config.ToolSpeedEnabled = value, () => config.ToolMultiplier, value => config.ToolMultiplier = value, 1, 4, 0.5);
