    ...
    internal sealed class FishingAutomationCompatibilityFeature : IGameBridgeFeature
    {
        ...
        private void WarnFrozenCompatibilityApi(string ownerId)
        {
            ...
            runtime.RuntimeMonitor.Log(
                "Mod " + ownerId + " called deprecated IFishingAutomationApi. This compatibility facade is frozen to new consumers; existing binary compatibility is retained until a separately approved breaking change. The self-contained Yuuka.DTMAPI.AutoFishing product does not replace or reopen this public API.",
                LogLevel.Warn);
        }
