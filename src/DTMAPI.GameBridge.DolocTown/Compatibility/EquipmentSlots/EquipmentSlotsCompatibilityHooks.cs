    ...
    internal sealed partial class EquipmentSlotsCompatibilityService
    {
        ...
        private bool TryReleaseCompatibilityHooks(string reason, out string result)
        {
            ...
            MethodInfo?[] targets =
            {
                ...
                FindExactTarget("DolocTown.BodyController, Assembly-CSharp", "OnAttacked", 4),
            ...
            ref bool __3)
        {
            ...
            lock (CallbackGate)
                target = callbackRuntime;
            return target?.HandleBodyControllerOnAttackedPrefix(__instance, __0, __1, __2, ref __result, ref __3) ?? true;
        }
