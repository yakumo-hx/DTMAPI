...
namespace DTMAPI.GameBridge.DolocTown
{
    ...
    internal sealed class GameBridgeFixtureStartupOptions
    {
        ...
        internal GameBridgeFixtureStartupOptions(
            ...
            bool requirePreRuntimeSaveIsolation = false)
        {
            ...
            RequirePreRuntimeSaveIsolation = requirePreRuntimeSaveIsolation;
        }
        ...
        internal bool RequirePreRuntimeSaveIsolation { get; }
    }
    ...
    internal interface IQaHostPreRuntimeParticipant
    {
        void PrepareBeforeRuntimeStart();
    }
