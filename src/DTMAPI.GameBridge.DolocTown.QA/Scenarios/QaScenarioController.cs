...
namespace DTMAPI.GameBridge.DolocTown
{
    ...
    internal sealed partial class QaScenarioController
    {
        ...
        internal void NotifyG6SaveLoaded(int? slot, bool isNewGame)
        {
            qaHostObservedSaveLoaded = true;
            NotifyG6SaveLoadedForFixture();
            NotifyMoreSavesFixed12SaveLoadedForFixture(slot, isNewGame);
        }
        internal void NotifyG6SaveSaved(int? slot) =>
            NotifyMoreSavesFixed12SaveSavedForFixture(slot);
