...
namespace DTMAPI.BepInExBootstrap
{
    internal sealed class DtmUiText
    {
        ...
        private static readonly Dictionary<string, string> SimplifiedChinese = new Dictionary<string, string>(StringComparer.OrdinalIgnoreCase)
        {
            ...
            ["mods.compatibilityExact"] = "精确匹配",
            ["mods.compatibilityDrift"] = "版本漂移",
            ["mods.compatibilityUnknown"] = "未知上下文",
            ["mods.compiledBuildLabel"] = "编译基线",
            ["mods.installedBuildLabel"] = "已安装构建",
            ["mods.referenceMatchLabel"] = "引用匹配",
        ...
        private static readonly Dictionary<string, string> English = new Dictionary<string, string>(StringComparer.OrdinalIgnoreCase)
        {
            ...
            ["mods.compatibilityExact"] = "exact",
            ["mods.compatibilityDrift"] = "drift",
            ["mods.compatibilityUnknown"] = "unknown context",
            ["mods.compiledBuildLabel"] = "compiled baseline",
            ["mods.installedBuildLabel"] = "installed build",
            ["mods.referenceMatchLabel"] = "reference match",
