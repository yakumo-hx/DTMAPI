...
- [batch6-managed-mod-identity-contract.md](batch6-managed-mod-identity-contract.md): corrected Phase 0, verified G2 synthetic fixture and the exact twelve-product Advanced/ProductNative baseline for manifest, Loader, SDK, Doctor, Manager, package and UI identities. Every proof remains identity- and policy-bound; later products, general Advanced authoring, G7 and the 0.5.5 release remain blocked.
