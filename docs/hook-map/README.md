...
- Evidence:
  ...
  - Save: local slot 3 / index 2.
  - Camera log line: `GAME-SMOKE/20260610-022332` records `Smoke diagnostics snapshot OK scenario=Camera, expectedFeatures=Camera, loadedMods=14, mods=14, errors=0, warnings=0, hooks=59, features=4, latestLog=..., latestReport=...dtmapi-report-20260610-022513.zip` and `Smoke.DiagnosticsSnapshot = verified`.
  - ActionSpeed log line: `GAME-SMOKE/20260610-022543` records `Smoke diagnostics snapshot OK scenario=ActionSpeed, expectedFeatures=ActionSpeed, loadedMods=14, mods=14, errors=0, warnings=0, hooks=63, features=4, latestLog=..., latestReport=...dtmapi-report-20260610-022623.zip` and `Smoke.DiagnosticsSnapshot = verified`.
...
- Regression cases: DIAGNOSTICS-SNAPSHOT-20260609, DIAGNOSTICS-SNAPSHOT-MOD-STATUS-20260610
...
- Evidence:
  ...
  - Save: local slot 3 / index 2.
  - Latest log line: `GAME-SMOKE/20260610-022332` logs `Feature.Camera = ready` for `PublishHookStatuses`, `InstallHooks`, `Update`, `ReturnedToTitle`, `SaveLoaded`, and `EnvironmentReset`, with `Feature status: id=Camera, lastOperation=..., success=True, failureCount=0, lastError=none`; `Smoke.DiagnosticsSnapshot = verified` confirms the structured diagnostics snapshot also contains `FEATURE Camera` and `mods=14`.
  - Screenshot/report: `docs/debug/evidence/GAME-SMOKE/20260610-022332`; report zip `docs/debug/evidence/GAME-SMOKE/20260610-022332.zip`.
- Regression cases: CAMERA-HOOK-OWNER-FEATURE-20260609, GAMEBRIDGE-FEATURE-HOST-HARDENING-20260609, CAMERA-PLAYABLE, DIAGNOSTICS-SNAPSHOT-20260609, DIAGNOSTICS-SNAPSHOT-MOD-STATUS-20260610
