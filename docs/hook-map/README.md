...
- Status: experimental / archived sample retired
...
- Mods/tests depending on it: none active as of 2026-06-15. Historical archived sample: `DTMAPI.SecondMotorMod`; historical smoke flag `-AutoExerciseVehicle` now returns a blocked archived result.
- Evidence:
  ...
  - Archive: 2026-06-15 user manual QA later found the SecondMotor sample effectively unusable because of abnormal light textures, abnormal farm-room textures, and severe cross-map texture pollution. The sample was moved to `archive/second-motor-20260615`, local packages were moved out of official `MODS`, and the API remains Experimental research only.
