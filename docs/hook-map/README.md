...
- Evidence:
  ...
  - Report note: the 2026-06-10 Oil feature split and pending-cleanup smokes did not export fresh report zips; their `latest-report.txt` files point to previous diagnostics/AnimalViewer reports and are not cited as OilCoalDrop report evidence.
