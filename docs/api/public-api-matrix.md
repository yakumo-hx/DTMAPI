...
| Migrated Gameplay | `IActionSpeedApi` | Experimental | Used by ActionSpeedMod with real gameplay smoke evidence. Latest feature-host split evidence is `GAME-SMOKE/20260609-133725`, which verifies tool animation, config apply, interaction slices, auto-fill, `Feature.ActionSpeed = ready`, and clean exit; earlier branch-package evidence remains `GAME-SMOKE/20260609-120153`. It still patches many interaction/animation paths and needs broader conflict/lifecycle regression coverage. |
