...
Latest baseline audit: [20260801-0002 Current Game vs 24256979 Reverse Baseline Audit](../../../archive/reviews/code/2026/20260801-0002-current-game-vs-24256979-reverse-baseline-audit.md)
...
Related coverage workbench: [Native Function Map](../../../../tools/native-function-map/workbench/README.md). Use it to see current reverse metadata, system-map coverage, native-owner report tags, and call relationships at a glance. It is a visualization aid, not API proof.

Related local mod demand index: [Local Mod Native Owner Review Library](../../../archive/reviews/api/2026/local-mods-native-owner/INDEX.md). Use it to see how current `testmods`, legacy local own-mod sources, and local third-party sample groups map back onto the same native-owner domains. It is demand and confidence evidence, not API proof.

Related ecosystem API research map: [SMAPI Ecosystem Semantic API Map](../../../archive/reviews/api/2026/smapi-ecosystem-map/INDEX.md). Use it to see clean-room ecosystem API concepts before narrowing a DTMAPI API rebuild to a Doloc native owner. It is architecture inspiration, not SMAPI compatibility or stability proof.

Related phase summary: [2026-07-06 API And Native Owner Phase Summary](../../../archive/reviews/api/2026/20260706-0001-api-native-owner-phase-summary.md). Use it as a short handoff before choosing the exact domain report.
...
- Runtime work still needs the [`PROJECT.md`](../../../../PROJECT.md) physical-owner classification, the authoritative domain save fixture, clean-exit checks, and public API matrix updates when a public contract changes. SharedNative/public adapters use GameBridge. G2 proves ProductNative packaging/lifecycle only for its synthetic fixture; the Catalog-generated [managed-product admission registry](../../../architecture/managed-product-admission-registry.md) owns the exact admitted real-product set and blocks every product beyond it. The Batch 6 / 0.5.5 annex is historical evidence only. ContentOwner uses an optional Content Host and remains G7-blocked.

## Source Index And Template

- [Source Index](SOURCE-INDEX.md)
- [Report Template](REPORT-TEMPLATE.md)
- [Three-Round Review Index](../../../archive/reviews/api/2026/native-owner-domains/review-rounds/INDEX.md)
...
| --- | --- | --- |
| Round 1 | Parallel challenge review, overclaim questions, and initial confidence scoring. | [Round 1 Challenges](../../../archive/reviews/api/2026/native-owner-domains/review-rounds/ROUND-1-challenges.md) |
| Round 2 | Parallel responses and supplemental native-owner findings. | [Round 2 Supplemental Report](../../../archive/reviews/api/2026/native-owner-domains/review-rounds/ROUND-2-supplemental-report.md) |
| Round 3 | Final review, required downgrades, and confidence scores for the revised claims. | [Round 3 Final Confidence](../../../archive/reviews/api/2026/native-owner-domains/review-rounds/ROUND-3-final-confidence.md) |
