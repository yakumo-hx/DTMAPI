...
| [ISSUE-020](ISSUE-020-20260805-enabled-official-source-arbitration.md) | open | Enabled-first official Local selection is source-verified; exact current Y-console Local bytes are now prepared, while cold-start Hook/behavior confirmation on game build `24585411` remains pending. |
