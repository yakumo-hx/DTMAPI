...
The next-version route is frozen in [`20260731 audio replacement bridge roadmap`](../../../planning/2026/20260731-audio-replacement-bridge-roadmap.md). It separates physical installation from behavioral verification, replaces status-string inference with a structured install result, and discusses scheduler granularity together with the already reviewed audio backend/event policy. It does not expand BGM, loops, STOP/callback ownership or the public Experimental API without new native-owner evidence.
