...
- Follow-up: `docs/updates/2026/20260615-0003-second-motor-scoped-asset-clone-cleanup.md` records the post-smoke fix for global asset-name leakage and failed-clone cleanup; save-slot 8 `GAME-SMOKE/20260615-192916` and save-slot 9 `GAME-SMOKE/20260615-193040` reverified the renamed scoped sprite path.
